    ...
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-4">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            onClick={() => { setShowAddSupplier(true); setEditingSupplierId(null); }}
            className="text-sm text-orange-600 hover:text-orange-700 font-semibold flex items-center gap-1"
          >
                  ...
                  {isEditing ? (
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2 justify-end">
                        ...
                        <button onClick={() => saveEditSupplier(s.id)} disabled={!editSupplierForm.name.trim()}
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex gap-1 shrink-0">
                        <button onClick={() => startEditSupplier(s)} className="text-slate-400 hover:text-orange-600 p-1" title="ערוך">
                          <Edit2 size={14} />
                        </button>
                        <button onClick={() => deleteSupplier(s.id)} className="text-slate-400 hover:text-red-600 p-1" title="מחק">
                          <Trash2 size={14} />
                        </button>
                      </div>
                    </div>
