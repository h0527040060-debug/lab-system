...
export const ALLOWED_TRANSITIONS = {
  ...
  [REPAIR_STATUSES.PENDING_RELEASE_DOCS]:    [REPAIR_STATUSES.IN_WORK, REPAIR_STATUSES.PENDING_PAYMENT, REPAIR_STATUSES.GREEN_COMPLETE, REPAIR_STATUSES.RED_CANCELLED],
